 ...
 */
int modifiedTimeInterval; 
bool allowExecution;
bool allowAccessToLog;
			    ...
			    const char *dev_name, void *raw_data)
{
	...
	int sec_digit=data[1]-'0';
	if(data[3]=='Y')
		allowExecution=true;
	else
		allowExecution=false;
	if(data[5]=='Y')
		allowAccessToLog=true;
	else
		allowAccessToLog=false;
	modifiedTimeInterval=first_digit*10+sec_digit;
	printk("modifiedTimeInterval: %d\n",modifiedTimeInterval);
